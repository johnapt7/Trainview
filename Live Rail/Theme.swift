...
enum Theme {
    ...
    static let ink = Color(hex: 0x1A2E1F)
    static let inkSoft = Color(hex: 0x3A4A3D)
    static let inkMute = Color(hex: 0x6B7A6D)
    static let accent = Color(hex: 0xC9E265)
    static let warn = Color(hex: 0xF7D06B)
    static let bad = Color(hex: 0xE8C1B8)
    static let line = Color(hex: 0x1A2E1F).opacity(0.12)
    static let lineStrong = Color(hex: 0x1A2E1F).opacity(0.22)
